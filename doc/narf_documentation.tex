...
One lazy design decision made was not to pass the \matlab{STACK} and \matlab{XXX} to each module. Although this could easily be done to allow modules to automatically initialize themselves, most of the time we want to set their values via a script. Perhaps some 
