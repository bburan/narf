* HIGH LEVEL GOALS:
  ...
  2. Make vocalization data (246) fits take < 1 day for IFN models
     - Smarter boosting algorithms (elitist stepping)
...
* Engineering
  ...
  4. [ ] Optimization: If a keyword string already exists, load that rather than refit all the way to that point....
  5. [ ] N Scatter plots of two models being compared, where N is the scatter plot for each performance metric.
  6. [ ] Correlation score that somehow discards outliers? MSE that discards outliers?
