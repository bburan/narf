...
* Next Steps: 
  1. SURVEYS AND REPORT: 
      ...
      - [X] All-in-One Fitters: mixfit0 is faster and better!
  ...
  3. General purpose scatter + marginals plot (Reuse scatter comparison?)
  4. Simple-Delay FIR keyword.
  5. Write a script that plots sparsity (summed overall) vs performance for a few model groups
  6. Modelstring bug.
  7. Why does SENL drop to keyboard?
  8. Heatmaps: loadstimfrombaphy, FIR, nonlinearity
  9. Metrics:
  ...
  10. Updated DB Insertion and Great Name Replacing proposal
  ...
  12. Boost algorithmic improvements. Comparison of Boost algorithms efficiency Per step, over time. 
  13. Better initial conditions.
  14. Outlier rejection. Exclude worst 1% in MSE calculations? Start at L2, gradually switch to L1 as time goes on?
  15. Narf Batch categories. 
