* NEXT STEPS:
  - Termination condition not absolute, but relative to initial starting point
  - Boosting with 10% hold-out data (cross validation)
  - Sparsity of NPFNL better than NPNL needs to be proven.
  - Boosting termination conditions checked and possibly improved
  - boostnrefitcp
  - Last N times the held out data has gone up 
