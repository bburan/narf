* ROADMAP
  ...
  2. Input-spanning depression bank training
  3. Start leveraging Stephen's job distribution code
  4. Cleaning, bugfixes, and user interface changes that have accumulated and are burying me
  5. Start using BAPHY for caching analysis results
