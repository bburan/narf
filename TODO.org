* Post-SVD Discussion
  - Run FIRNO and not depfree for CP/NL interaction survey
  - Boost0 keyword is our new default. 
  - Rootfreeb is rootfree with a baseline, same for logfreeb
  - Status report for the selected models only
  - Add # of neurons to the barplot. Add also the mean.
  - Rerun all surveys with boosto0
...
* Avenues of Research
  ...
  11. Engineering fixes
      1) Allow queueing of just a subset of analysis
      2) Modelstring bug
