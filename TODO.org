...
** Features
   Better searching/sorting of semi-arbitrary keywords
   Better scatter plot graphing

- Clean up saved_analysis, saved_models, saved_images
- Look at write permissions for images
...
* Why an FPGA would kick ass for this stuff
  - You could try all 300 coefficient boosting steps simultaneously
