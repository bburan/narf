...
* NEW FEATURES
  1. [X] Prepare big batch file for weekend. 233, 240, 241, 242. 
  2. [X] CLEAN: Vectorize SENL
  3. [X] Start training on r instead of r^2 so that nonlinearities are always rightward increasing.
  4. [ ] CLEAN: sf=sf{1}; should be eliminated IN EVERY SINGLE FILE!
  5. [ ] CLEAN: 'unused' should become ~ IN EVERY FILE
