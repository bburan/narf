* ROADMAP
  1. [ ] Skeleton script to Stephen
  2. [ ] Start using mysql for caching analysis results
  3. [ ] Start using queue system for starting model training files
  4. [ ] Across-file NPNL 
  5. [ ] Cleaning, bugfixes, and user interface changes that have accumulated
  6. [ ] Address question: Does variation in neural fuction as in A1 follow a continuum, or are there visible clusters?
