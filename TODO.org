* NEXT STEPS:
  1. [ ] Go through utils/ and check documentation is up-to-date...
  2. [ ] Move 'define_dims' to an 'incomplete' directory of code that isn't used yet.
  3. [ ] Examine the cause of the error when loading "por022b12_a_TSP"
  4. [ ] Try nlinfit 
