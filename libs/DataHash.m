...
% HACK BY IVAR: Remove the "workspace" field to prevent infinite recursion
% when there is a function that references itself. 
if isfield(FuncKey, 'workspace')
    FuncKey = rmfield(FuncKey, 'workspace');
end
