...
% Ben Willmore, Apr '03. adjusted so that if you provide a matrix of
% integer values between 0 and 255, and a range of [0 255], the values
% written to the file are exactly the ones in the matrix. no rounding,
% no flooring, no bullshit.

function range = pgmWritebw(mtx, fname, range, type, comment );
