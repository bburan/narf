% function [xc,celllist]=batchcomp(batches,nloutidx,cnfidx,newfig,xcflag);
%
...
%         2 cc corrected for validation noise (predinf)
%
% created SVD 12/02
%
function [xc,celllist,p]=batchcomp(batches,nloutidx,cnfidx,newfig,xcflag,bcellid);
