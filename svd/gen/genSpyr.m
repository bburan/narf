% RANGE = genSpyr (PYR, INDICES, RANGE, GAP, LEVEL_SCALE_FACTOR)
% 
% Created SVD 7/2/01 - Hacked out of Eero Simoncelli's showSpyr
% code.  Basically the same thing, but return the image of the
% pyramid scaled 0-255 rather than displaying it.
%
%
...
function [d_im] = genSpyr(pyr, pind, range, gap, scale);
