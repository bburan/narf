% function queueidx=dbaddqueueisr(parmstring,[note],priority[=1]);
%
...
%
% created SVD 5/28/07 -- ripped off of dbaddqueuemaster
%
function queueidx=dbaddqueueisr(parmstring,note,priority,rundataid,user);
