function fitSubstack(startidx,stopdelta,output)
    ...
    % use scaat to set ICs for static nonlinearities
    if 0 & (strcmp(STACK{end-1}{1}.name,'nonlinearity') || ... 
            strcmp(STACK{end-1}{1}.name,'pole_zeros') || ... 
            strcmp(STACK{end-1}{1}.name,'int_fire_neuron')),
        fit_scaat('StopAtAbsScoreDelta', stopdelta, ...
                  'StopAtStepNumber', 10);
    else
