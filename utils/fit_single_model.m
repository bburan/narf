...
if length(db_results) > 1
    ...
    for ii = 1:length(keywords_to_exec)
        if ~strcmpi(keywords_to_exec{ii},'fit05') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05a') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05b') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05c') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05d') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05e') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05f') && ...
                ~strcmpi(keywords_to_exec{ii},'fit05g')
