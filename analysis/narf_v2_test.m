...
mm = {'env100', ...
      ...
      'mse', ... % {'mses0', 'mses1', 'mses2', 'mses3', 'mses4', 'mses5', 'mses6', 'mses7', 'mses8', 'mses9', }, ...
      'shboo'};% {'fmin', 'fminlsq', 'boost', 'fminu', 'qfmin', 'qlsq', 'qboost', 'lsqn', 'genetic', 'anneal', 'sb', 'sp1boost', 'sp2boost', 'sp3boost', 'sp4boost', 'sp5boost'}};
