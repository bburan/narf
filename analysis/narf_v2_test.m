...
mm = {'env100', ...
      {'inferp1','inferp2','inferp3','inferp4','inferp5','inferp6', 'inferp10','inferp20'}, ...
      'log2b', ...
      'firno', ... % {'firn', 'firno', 'depn', 'firnv2'}, ...
      'initrc', ... 
      'nonl', ... % {'npnl', 'npfnl', 'npnlx', 'npfnlx', 'nonl'}, ...
      'mse', ... % 'mse', ... %{'mses0', 'mses1', 'mses2', 'mses3', 'mses4', 'mses5', 'mses6', 'mses7', 'mses8', 'mses9', }, 
      'qboost'}; % {'fmin', 'fminlsq', 'boost', 'fminu', 'qfmin', 'qlsq', 'qboost', 'lsqn', 'genetic', 'anneal', 'sb', 'sp1boost', 'sp2boost', 'sp3boost', 'sp4boost', 'sp5boost'}};
